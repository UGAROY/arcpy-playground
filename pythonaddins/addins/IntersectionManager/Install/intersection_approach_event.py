import arcpy
from intersection_util import geodesic_angle_to_circular_angle, geodesic_angle_to_direction, calculate_leg_type_property, populate_leg_id_by_intersection
from tss_util import transform_dataset_keep_fields, log_message, alter_field_name
    ...
    def populate_beg_end_inf(self):
        ...
        with arcpy.da.UpdateCursor(segments_join_intersections,
            ...
            for uRow in uCursor:
                ...
                uRow[3] = round(uRow[3], self.measure_scale)
                uRow[4] = round(uRow[4], self.measure_scale)
                uCursor.updateRow(uRow)
